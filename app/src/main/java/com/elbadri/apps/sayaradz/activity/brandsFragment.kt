...
import com.elbadri.apps.sayaradz.activity.dummy.BrandsContent
...
class brandsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MybrandsRecyclerViewAdapter(BrandsContent.ITEMS, listener)
            }
        }
        return view
    }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: Brand?)
    }
